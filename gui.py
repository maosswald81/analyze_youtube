...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.title("AI Anaylzer App")
        # Keep the title bar and window controls
        # self.overrideredirect(True)  # Commented out to allow window controls (minimize, maximize, close)
    ...
    def close_window(self):
        self.destroy()  # This will close the entire window when called.

    # Clear all widgets in the right dashboard frame
